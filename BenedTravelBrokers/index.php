<?php
    ...
    include './database/delete.php';
        ...
        $fetchImages = getImages($conn);

        include "./menu/header.php";
include "./menu/headerMobile.php"; 
?>
    </section>
   <section id='home'  class="w-full flex justify-center mt-[180px]">
        ...
        <div class=" bg-white bg-opacity-40 container absolute w-[1000px] xl:w-[1200px] h-[100px] flex justify-center items-center backdrop-blur-lg">
                <div class="w-[950px] xl:w-[1100px]  container h-auto absolute m-[10px]  ">
                        <form action="" class="flex font-primary"> 
                                ...
                                <select name="" id="" class="w-[25%] py-[15px] bg-white  ps-5 form-select border focus-ring focus-ring-light rounded-2" id="target">
                                ...
                                <select name="" id="" class="w-[25%] py-[15px] bg-white  ps-5 form-select" id="target">
   ...
   <?php include ("./menu/Mobile-search-tour.php"); ?>
    ...
    <section id='about' class="w-full flex justify-center bg-color5 h-auto">
        ...
        <div class="w-full container 2xl:px-36">
                <div>
                        ...
                        <div class="flex flex-wrap md:justify-between gap-10 px-6 xl:px-0 py-8 lg:px-3 ">
                                <?php foreach($fetchImages as $data): ?>
                                <figure class="w-full md:w-[45%] xl:w-[30%] h-[450px] relative photo transition-all duration-1000 ">
                                        <div class="w-[100%] h-[100%] bottom-photo absolute bg-white flex flex-col justify-center px-5">
                                                <p class="text-3xl text-color3 capitalize font-secondary"><?php echo $data['location']; ?> tour</p>
                                                <p class="text-color1 mb-4">$<?php echo $data['price']; ?> / per persons</p>
                                                <p class="text-color6"><?php echo $data['description']; ?></p>
                                                <div class="flex flex-wrap my-4">
                                                        <div class="w-[50%] flex"><i class="bi bi-clock text-color4"></i><p class="text-color6 ms-2"><?php echo $data['duration']; ?> Days</p></div>
                                                        <div class="w-[50%] flex"><i class="bi bi-geo-alt text-color4"></i><p class="text-color6 ms-2"><?php echo $data['location']; ?></p></div>
                                                        <div class="w-[50%] flex"><i class="bi bi-person text-color4"></i></i><p class="text-color6 ms-2"><?php echo $data['minimum_age']; ?>+</p></div>
                                                        <div class="w-[50%] flex"><i class="bi bi-emoji-smile text-color4"></i></i><p class="text-color6 ms-2"><?php echo $data['rating']; ?> Superb</p></div>
                                                </div>
                                                <a href="" class="underline decoration-color1 text-color6 flex mb-2">Tour details</a>
                                        </div>
                                        <img src="img/<?php echo $data['image']; ?>" alt="" class="w-[100%] h-[100%] object-cover brightness-75 absolute">
                                        <p class="absolute uppercase text-white bg-color3 px-4 py-1 right-1 top-12 rotate-[-90deg] "><?php echo $data['location']; ?></p>
                                        <figcaption class="absolute text-white bottom-8 right-10 fig">
                                                <p class="capitalize font-secondary text-3xl"><?php echo $data['location']; ?> tours</p>
                                                <p class="text-right">$<?php echo $data['price'];?> / per persons</p>
                                        </figcaption>
                                </figure>
                                <?php endforeach; ?>
