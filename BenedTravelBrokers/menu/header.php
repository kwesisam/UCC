...
<style>
    ...
    .col:hover{
        background-color: #FCB50053!important;
    }
</style>
<body class="font-primary">
    ...
    <section id="home" class="w-full h-[100vh]  bg-header  bg-cover bg-no-repeat bg-center bg-color1 bg-blend-multiply bg-opacity-60 " >
    <p  class='floating_btn'><a href="#home" ><svg xmlns="http://www.w3.org/2000/svg"  width="20" height="20" fill="white" class="bi bi-arrow-up" viewBox="0 0 16 16">
